...
The EDR triage generator (design: docs/edr/design-edr-2026-06-11.md §6).
...
(docs/edr/design-edr-tiered-oversight-2026-06-11.md §4 Move 1): the work
...
``unrouted (operator)``)
─────────────────────────────────────────────────────────────────────────
Aspect names mirror the registry table in docs/META-session-guide.md
...
#    Aspect names mirror docs/META-session-guide.md §Aspect registry. ─────────
