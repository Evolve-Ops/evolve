...
the real imported ``signals.store`` (design: internal/edr/design-edr-2026-06-11.md
...
Adapters are tier interfaces (internal/edr/design-edr-tiered-oversight-2026-06-11.md
