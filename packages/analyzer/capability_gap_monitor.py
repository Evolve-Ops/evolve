...
def _bot_workspace_agents_md(bot_id: str) -> Path:
    ...
    back to profile-keyed construction as a last resort but only for the
    path construction — the read still requires the file to actually be
...
def detect_capability_gaps(
    ...
    *,
    ...
    # marker convention. See internal/spec-rsi-proposal-eligibility-
