...
Spec: docs/spec-app-audit-2026-05-16.md.
...
# docs/finding-new-bot-activation-cost-2026-06-12.md, decision D). We defer the
...
#
# Spec: docs/footprint-disk-output-audit-2026-06-28.md.
#
...
#
# Retention (footprint cut, 2026-06-28; docs/footprint-antipattern-cross-app-
    ...
    *,
    ...
    for path, manifest in manifests:
        ...
        if findings:
            ...
            # Spec: docs/spec-recommendations-rework-2026-06-02.md
