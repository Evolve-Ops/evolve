...
HEADLINES: dict[str, str] = {
    ...
    "apps.mostly_untied_remediation": "Most of the pod's work was not tied to "
                                      ...
                                      "that.",
    # An app id the pod's catalogue cannot name. A noun phrase, not a
    # sentence: it fills the {app} slot of the lines above and a bar label.
    "apps.unknown_app": "unknown app ({app_id})",
