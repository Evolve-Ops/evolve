...
Spec: internal/spec-mcp-administration-2026-05-10.md §3.1 (CatalogEntry) +
...
def default_entries() -> list[CatalogEntry]:
    ...
    return [
        ...
        CatalogEntry(
            ...
            required_env=[
                ...
                RequiredEnv(
                    ...
                    purpose=(
                        ...
                        "v1 (see internal/vetting-workspace-mcp-2026-06-04.md §6)."
                    ),
                    scope_recommendation=(
            ...
            vetting_status="approved",
            vetting_notes=(
                "Vetted 2026-06-04 — see internal/vetting-workspace-mcp-2026-06-04.md. "
        ...
        CatalogEntry(
            ...
            vetting_status="candidate",
            vetting_notes=(
                "Vetted 2026-06-06 — see internal/spec-zoom-skill-2026-06-06.md. "
