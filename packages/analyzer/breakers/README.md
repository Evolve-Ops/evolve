...
[docs/spec-circuit-breakers-2026-05-21.md](../../../docs/spec-circuit-breakers-2026-05-21.md)
for the full design.

This module is **observe-only**. It detects activity-shape anomalies
that *would* trip an L1 cost breaker, but does not write trip state,
restart anything, or modify any bot. The actual state store,
enforcement, UI, and auto-trip wiring land in Phases 2 through 5.
