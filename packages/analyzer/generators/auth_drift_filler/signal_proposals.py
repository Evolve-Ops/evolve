...
Investigate-before-propose (spec docs/spec-config-intent-system-2026-05-21.md
...
read-only ACL. See docs/diagnosis-openclaw-json-write-regression-2026-05-21.md.
"""
...
def make_drift_proposals(signal: Any,
    ...
    (spec docs/spec-config-intent-system-2026-05-21.md §4). For each
