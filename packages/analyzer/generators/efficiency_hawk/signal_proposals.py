...
def make_daily_spend_proposal(signal: Any) -> Proposal:
    ...
    return Proposal(
        ...
        # surface=improvement. See docs/spec-rsi-proposal-eligibility-
...
def make_cron_wakes_agent_proposal(signal: Any) -> Proposal:
    ...
    return Proposal(
        ...
        # docs/spec-rsi-proposal-eligibility-2026-06-05.md (audit row:
...
def make_cron_overactive_proposal(signal: Any) -> Proposal:
    ...
    return Proposal(
        ...
        # Alerts. See docs/spec-rsi-proposal-eligibility-2026-06-05.md
...
def make_context_bloat_proposal(signal: Any) -> Proposal:
    ...
    return Proposal(
        ...
        # to Alerts. See docs/spec-rsi-proposal-eligibility-
...
def make_session_token_outlier_proposal(signal: Any) -> Proposal:
    ...
    return Proposal(
        ...
        # proposed. Routes to Alerts. See docs/spec-rsi-proposal-
