...
def test_tier0_no_longer_resolves_a_chain():
    # tier0 (the legacy judge slot) has no role since the judge-role collapse
    # (design-judge-role-collapse-2026-08-21 §5.4): resolve_tier_chain reports
    # it unconfigured ([]), while the file itself stays parseable.
