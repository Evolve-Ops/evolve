...
REAL_MODEL_IDS: dict[str, set[str]] = {
    ...
    # Verified against platform.kimi.ai/docs/models (2026-07): the active
    # listing is kimi-k3 / kimi-k2.7-code(-highspeed) / kimi-k2.6; the
    # kimi-k2 originals and moonshot-v1-* are sunset.
    "moonshot": {
        "kimi-k3",
        "kimi-k2.6",
    },
