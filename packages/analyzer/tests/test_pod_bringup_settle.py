...
Falsifiable proof artifact for docs/spec-pod-bringup-settle-2026-06-23.md.
...
def _run_audit_emit(audit, criticals, warns, shared_dir, monkeypatch):
    ...
    monkeypatch.setattr(signals_store, "observe", _fake_observe)
...
def test_watchdog_acl_fires_after_settle(tmp_path):
    ...
    # docs/spec-transient-signal-suppression-2026-06-23.md) now requires the
