...
SAME four-role primaries. This test pins the Python side to the shared fixture
...
defaults-only resolves all four roles, pod beats default, bot beats pod, and
...
_ROLES = ("fast", "standard", "power", "max")
...
def test_python_resolution_matches_shared_fixture(scenario):
    ...
    the four roles to the fixture's expected primaries."""
