...
def test_default_targets_cover_the_three_known_logs():
    """Regression guard: the three files this module was created to cap
    must stay in DEFAULT_TARGETS. Adding paths is fine; silently dropping
    one of these would re-expose the original disk-fillup risk."""
