...
def test_known_cause_ids_matches_pattern_table() -> None:
    ...
    # The 2026-08-18 vault lockout. Named without a `backup_` prefix to match
    # every other id here — the `backup_` prefix belongs to the Signal TYPE
    # (`backup_ssh_key_mismatch`), not to the cause.
    assert "pat_unreadable" in ids
