...
# The 14 real gallery apps carry these tags; we use the real catalog so the
# cross-reference is faithful. Loaded once.
GALLERY = targeting._load_gallery_catalog()
