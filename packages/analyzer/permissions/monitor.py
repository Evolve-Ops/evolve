...
Spec: docs/spec-permission-posture-2026-05-10.md §3.3 (Signals) + §5.2
(drift detection).
...
OWNED_SIGNAL_TYPES: frozenset[str] = frozenset({
    ...
    # Autonomy ladder (docs/spec-autonomy-ladder-2026-06-10.md §4.2.1
...
def _filter_intentional_deviations(
    ...
    config_intent record (spec docs/spec-config-intent-system-2026-05-21.md §4).
...
def _autonomy_findings(
    ...
    *, create_entries: bool = True,
    ...
    Spec docs/spec-autonomy-ladder-2026-06-10.md §4.2.1 (drift), §5.2
