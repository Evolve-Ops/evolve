...
Spec: internal/spec-permission-posture-2026-05-10.md §3.2 (PermissionInventory).
...
# Public seam for cross-package consumers (pod_baseline.census): the error
# vocabulary is part of the contract — "not_found" distinguishes an absent
# file from a permission wall / parse failure.
NOT_FOUND = "not_found"
...
# Public alias — the sanctioned shared reader for bot-owned JSON (direct read
# via the evolve ACL, sudo /bin/cat fallback, absent ≠ unreadable). External
# packages import this name, not the underscore original.
