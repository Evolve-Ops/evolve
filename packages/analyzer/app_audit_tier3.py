...
See docs/spec-app-audit-2026-05-16.md §4-5.
"""
...
# See docs/forensic-team_bot_a-apply-bleed-2026-05-21.md.
...
def run_tier3_for_app(
    *,
    ...
    behavior. Decision C, docs/finding-new-bot-activation-cost-2026-06-12.md.
    """
