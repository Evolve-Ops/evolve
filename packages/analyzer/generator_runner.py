...
def _make_exec_outcome_investigator_ctx(
    ...
    Spec: internal/spec-exec-outcome-watchdog-2026-05-28.md (Phase 2).
    """
...
def _make_app_permission_review_ctx(
    ...
    Spec: internal/spec-app-permission-review-2026-05-26.md (B.2).
    """
...
def _make_autonomy_promoter_ctx(
    ...
    internal/spec-autonomy-ladder-2026-06-10.md §3.2).
...
_CONTEXT_FACTORIES: dict[str, tuple[Any, bool]] = {
    ...
    # plugin-posture rework (internal/spec-plugin-posture-rework-2026-06-06.md).
    ...
    # internal/decision-retire-primary-model-floor-advisor-2026-06-04.md for
...
def run_one_generator(
    ...
    *,
    ...
    Spec: internal/spec-app-permission-review-2026-05-26.md §"scan_workspace_pipeline integration".
    """
    if log_fn is None:
        log_fn = logger.info
