...
_TIER_ALIAS: dict[str, str] = {
    ...
    "sonnet": "tier2",
    "opus": "tier1",
    # "judge"/"tier0" deliberately unmapped since the judge-role collapse
    # (design-judge-role-collapse-2026-08-21): nothing routes to tier0, so a
    # proposal naming it is refused with the unknown-tier message below.
    "tier1": "tier1",
    "tier2": "tier2",
    "tier3": "tier3",
}
        ...
        if tier is None:
            return ApplyResult(
                ...
                message=(
                    ...
                    f"(tier1..tier3) or alias (haiku/sonnet/opus)"
                ),
            )
