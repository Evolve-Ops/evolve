...
Spec:
  - docs/spec-openclaw-json-derived-artifact-2026-05-24.md §7 (L2 applier
    pattern: overrides → materialize → safe_write → kickstart).
  - docs/spec-cache-retention-tunable-2026-05-30 (PR A — surfaced the
...
def _record_applier_intents(
    *, bot_id: str, fields: dict, proposal_id: str | None,
    ...
    Spec docs/spec-config-intent-system-2026-05-21.md §3 — every code
