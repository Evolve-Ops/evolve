...
# out of sync. See docs/spec-openclaw-json-derived-artifact-2026-05-24.md
...
def _record_applier_intents(
    *, bot_id: str, fields: dict, proposal_id: str | None,
    ...
    Spec docs/spec-config-intent-system-2026-05-21.md §3 — every code path
...
class UpdatePermissionConfigApplier:
    ...
    def apply(
        ...
        *,
        ...
        # record_intent_on_set reflex (spec docs/spec-config-intent-system-2026-05-21.md §3):
