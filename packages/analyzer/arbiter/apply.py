...
_MANUAL_COMPLETION_KINDS = frozenset(
    {
        "Investigation",
        # Guardian risk info a person reads and closes out, the same shape as
        # Investigation. It was the one INFORMATIONAL_KIND that was not here,
        # so it would have auto-succeeded on apply — "acknowledged" without
        # anyone having acknowledged it. Being here also makes it
        # breaker-exempt, which is right: it writes nothing.
        "VetoAnnotation",
        "WorkflowInstruction",
