...
def compute_cost_score(
    ...
    if total_billable == 0:
        ...
        components.append({
            ...
            "fix": None if ok else (
                ...
                "fragmenting sessions, and raise the Compaction budget so "
                "compaction doesn't invalidate the cached prefix as often."
            ),
    ...
    if not session_input:
        ...
        components.append({
            ...
            "fix": (
                "Sessions are growing unbounded. Lower the Compaction budget "
                "so compaction fires sooner; consider "
