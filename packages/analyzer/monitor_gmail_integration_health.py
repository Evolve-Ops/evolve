...
[docs/spec-google-integration-paths-2026-05-30.md] describes this monitor;
...
def _signal_spec_for_bot(
    ...
    *,
    ...
    if mode == "free_gmail_oauth":
        ...
        runbook_url = "docs/runbook-google-oauth-personal.md"
    else:
        remediation_url = (
            "docs/spec-google-integration-paths-2026-05-30.md#8-health-monitor"
        )
        runbook_url = "docs/runbook-path-c-google-integration.md"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Google integrations. Spec: docs/spec-google-integration-paths-"
            "2026-05-30.md §8."
        ),
    )
