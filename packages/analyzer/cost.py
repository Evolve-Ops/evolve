...
from evolve_config import (
    ...
    resolve_network_path, bot_home as _bot_home,
)
...
def _check_and_propose(report: BotCostReport, shared_dir: Path, config: dict) -> None:
    ...
    # spec — see internal/spec-alert-subscriptions-2026-05-10.md § 2.6.
...
def _write_proposal(
    ...
    # No evolve_sig stamp — HMAC proposal signing retired 2026-08-18
