...
FAMILY_COST_BAND: dict[str, str] = {
    ...
    "mistral-small": "low",
    "codestral": "medium",
    # Moonshot Kimi lines (k3 = 1M-context flagship at sonnet-band pricing;
    # k2.6 / k2.7-code = cheap agentic workhorses). The version token isn't
    # pure-numeric ("k3", "k2.6") so `_family_of` keeps each line as its own
    # family stem — one row per line, like gpt-4o.
    "kimi-k3": "medium",
    "kimi-k2.6": "low",
    "kimi-k2.7-code": "low",
}
