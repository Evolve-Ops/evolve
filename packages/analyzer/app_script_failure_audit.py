...
``docs/spec-agent-freelance-bypass-2026-06-05.md``, and both walk the same
...
(agent) failed``; see ``docs/spec-app-derived-permissions-2026-05-24.md``):
...
def _spec_for_failure(totals: BotAppFailureTotals, lookback_hours: int) -> dict:
    ...
    body_lines.append(
        ...
        "`docs/spec-agent-freelance-bypass-2026-06-05.md` for the gap and the "
