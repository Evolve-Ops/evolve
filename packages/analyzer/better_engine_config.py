...
_COMPILED_DEFAULTS: dict[str, Any] = {
    ...
    "budget": {
        ...
        # ── Phase 5 of cost-cap normalization (spec: docs/spec-cost-caps-2026-06-05.md) ──
    ...
    # Spec: docs/spec-better-engine-conversational-approval-2026-04-18.md
...
# Finding: docs/finding-new-bot-activation-cost-2026-06-12.md (decision B).
#
...
class BetterEngineConfig:
    ...
    # added in Phase 5. Spec: docs/spec-cost-caps-2026-06-05.md. Each field
    ...
    def _resolve_per_bot_opt_in_float(
        ...
        if bot_id is None:
            return None
        bot_config = self.bots.get(bot_id, {})
        value = _walk(bot_config, ("budget", field))
        if value is _SENTINEL or value is None:
            return None
        try:
            f = float(value)
