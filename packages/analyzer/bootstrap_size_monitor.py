...
Related: internal/spec-context-observability-2026-07-30.md (the wider
context-observability plan; this producer satisfies its §Implementation
contract) and internal/spec-evolve-overhead-budget-2026-07-31.md §A1 (the
...
# injection cap and combined-total cap (internal/spec-evo-oc-native-2026-05-19.md
