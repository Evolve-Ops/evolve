...
Reads on-disk telemetry only (no LLM):
  ...
  - openclaw cron records at /Users/{bot}/.openclaw/cron/jobs.json
  - openclaw cron run logs at /Users/{bot}/.openclaw/cron/runs/<cron_id>.jsonl
...
def workspace_md_sizes(
    ...
    Scans ``/Users/<bot>/.openclaw/workspace/`` top-level, plus a small
...
def read_openclaw_json(
    ...
    """Read /Users/<bot>/.openclaw/openclaw.json. Returns None on failure.
            ...
            "details": {
                ...
                **_v2_context_from_day(cur_window_events),
                ...
                "fix_steps": (
                    ...
                    f"`/Users/{bot_id}/.openclaw/openclaw.json` and "
                    f"`/Users/{bot_id}/.openclaw/cron/jobs.json`\n"
            ...
            "details": {
                ...
                **_v2_context_from_day(window_events),
                ...
                "fix_steps": (
                    ...
                    f"`/Users/{bot_id}/.openclaw/openclaw.json` "
        ...
        out.append(
            {
                ...
                "details": {
                    ...
                    "fix_steps": (
                        ...
                        f"/Users/{bot_id}/.openclaw/cron/runs/"
        ...
        out.append(
            {
                ...
                "details": {
                    ...
                    "fix_steps": (
                        ...
                        f"   ssh pod_admin_user@mini sudo /bin/cat "
                        f"/Users/{bot_id}/.openclaw/workspace/{name}\n"
    ...
    return [
        {
            ...
            "details": {
                ...
                "fix_steps": (
                    ...
                    f"/Users/{bot_id}/.openclaw/workspace -type f -name '*.md' "
                    f"-printf '%s %p\\n' | sort -rn | head -10\n"
        ...
        out.append(
            {
                ...
                "details": {
                    ...
                    "fix_steps": (
                        ...
                        f"   ssh pod_admin_user@mini sudo grep '{bot_id}' "
                        f"/Users/Shared/evolve/logs/admin-actions.jsonl "
                        f"| tail -10\n"
                        f"3. Check apply log for the bot:\n"
                        f"   ssh pod_admin_user@mini sudo grep -i "
                        f"'{dotpath.split('.')[-1]}' "
                        f"/Users/{bot_id}/.openclaw/logs/evolve-apply.log\n"
        ...
        out.append(
            {
                ...
                "details": {
                    ...
                    "fix_steps": (
                        ...
                        f"   ssh pod_admin_user@mini sudo /bin/cat "
                        f"/Users/{bot_id}/.openclaw/workspace/{name} | tail -100\n"
                ...
                "details": {
                    ...
                    **_v2_context_from_session_slot(slot),
                    ...
                    "fix_steps": (
                        ...
                        f"'\"session_id\":\"{sid}\"' "
                        f"/Users/Shared/evolve/{bot_id}/cost_events/"
                        "*.jsonl | head -50"
                    ),
                },
            }
    ...
    return [
        {
            ...
            "details": {
                ...
                "fix_steps": (
                    ...
                    f"   sudo /bin/cp /Users/{bot_id}/.openclaw/workspace/HEARTBEAT.md "
                    f"/Users/{bot_id}/.openclaw/workspace/HEARTBEAT.md.bak\n"
                    f"   sudo /usr/bin/tee /Users/{bot_id}/.openclaw/workspace/HEARTBEAT.md "
    ...
    return [
        {
            ...
            "details": {
                ...
                "fix_steps": (
                    ...
                    f"/Users/{bot_id}/.openclaw/logs/openclaw.log | grep "
                    "'heartbeat: started\\|SIGTERM' | tail -50\n"
                    "2. If repo-puller-driven: check "
                    "/Users/Shared/evolve/logs/repo-puller.log for "
    ...
    return [
        {
            ...
            "details": {
                ...
                "fix_steps": (
                    ...
                    f"`/Users/{bot_id}/.openclaw/openclaw.json` (e.g. "
                    f"`\"every\": \"4h\"`).\n"
        ...
        out.append(
            {
                ...
                "details": {
                    ...
                    "fix_steps": (
                        ...
                        f"`/Users/{bot_id}/.openclaw/exec-approvals.json` "
                        "for stale entries\n"
    ...
    return [
        {
            ...
            "details": {
                ...
                "fix_steps": (
                    ...
                    f"/Users/{bot_id}/.openclaw/logs/openclaw.log "
