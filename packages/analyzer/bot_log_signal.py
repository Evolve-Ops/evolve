...
_PATTERNS: list[_AnyPattern] = [
    ...
    _AnyPattern(
        ...
        body=(
            ...
            "syncing models.providers from the upstream catalog (see "
...
_OPERATOR_DOCS: dict[str, tuple[str, str]] = {
    ...
    "unknown_provider_model": (
        ...
        "2. Re-sync the provider registry from the upstream catalog:\n"
        "   sudo evolve-admin sync-provider-models --bot <bot>\n"
        "   (wraps oc_model.sync_provider_models_from_catalog with the "
        "safe pre-write validator added in PR #2059)\n"
