...
``internal/design-phase4.3-runtime-adapter-seam-2026-06-09.md``.
...
class AgentRuntime(Protocol):
    ...
    def gateway_stop(self, bot_id: str, network_path: "str | None" = None) -> dict: ...
...
class OpenClawRuntime:
    ...
    def gateway_stop(self, bot_id: str, network_path: "str | None" = None) -> dict:
        return self._oc().oc_gateway_stop(bot_id, network_path=network_path)
...
class FakeRuntime:
    ...
    def gateway_stop(self, bot_id: str, network_path=None) -> dict:
        # No trailing-semicolon one-liner here (the neighbours predate the
        # E702 ratchet, which is shrink-only — a new one would raise it).
        self.calls.append(("gateway_stop", bot_id))
