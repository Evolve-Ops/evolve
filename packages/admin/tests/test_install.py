...
def _make_oc_json(
    ...
    if with_cost_defaults:
        ...
        cfg["tools"] = {
            ...
            # internal/spec-app-derived-permissions-2026-05-24.md). Tests that
...
class TestEnsurePluginConfig:
    ...
    def test_corrects_deny_to_full_when_no_explicit_override(self):
        ...
        See internal/spec-app-derived-permissions-2026-05-24.md §"Migration plan
...
class TestInstallOcPluginSignedBypass:
    """Spec: internal/spec-plugin-install-trust-2026-06-06.md §4.
