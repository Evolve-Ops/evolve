...
class TestRegistry:
    def test_all_currently_listed_skills_present(self):
        ...
        # audit; see internal/skills-deep-audit-2026-05-30.md). gdrive piggybacked
        ...
        for withdrawn in ("dropbox", "gdrive", "unity"):
            assert withdrawn not in ups.SKILLS, (
                ...
                f"internal/skills-deep-audit-2026-05-30.md for context."
            )
...
# audit; see internal/skills-deep-audit-2026-05-30.md). They no longer have
...
class TestInstallPlan:
    ...
    def test_missing_status_yields_manual_setup_plus_confirm_for_non_github(self):
        ...
        # Regression guard from internal/audit-skills-install-flows-2026-05-30.md:
