...
# ``decisions.proposal_rejected`` (one of the original 8) retired 2026-08-14
# with review.py's last advertising surfaces — it was already internal and
# notify=False, and #3641 deleted its only emitter.
