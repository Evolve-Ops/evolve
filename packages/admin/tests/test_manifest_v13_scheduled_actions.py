...
(internal/spec-audit-extensions-2026-05-17.md §3). Verifies that:
...
def test_schema_version_is_30() -> None:
    ...
    internal/spec-proactive-delivery-monitor-2026-06-10.md §5).
    ...
    (Bite 1; internal/spec-apps-meta-2026-06-13.md §9). See
    test_manifest_definition_status.py.
    v28 adds drift_log — the drift-narrative log (Bite 3;
    internal/spec-apps-meta-2026-06-13.md §9.3). See test_drift_classifier.py.
    v29 adds provided_capabilities[] — the app-declared half of the Layer-2
    per-role tool-loading model (internal/spec-user-roster-and-roles-2026-06-07.md
    §4/§8). See test_manifest_v29_provided_capabilities.py.
    v30 adds app_id + draft_id — the canonical identity field (AL-1.4a;
    internal/build-AL-1.4-app-id-canonical.md §2). See
    test_manifest_v30_app_id.py.
    """
