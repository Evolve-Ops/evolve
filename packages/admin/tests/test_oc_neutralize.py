...
def test_extract_install_error_falls_back_to_last_line():
    """No known pattern matches → last non-empty line is better than nothing."""
    got = ocn.extract_install_error("first line\nsomething useful here", "")
    assert got == "something useful here"
