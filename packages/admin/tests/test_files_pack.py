...
def test_schema_version_is_30():
    """Pinned to surface unintended bumps. v30 adds app_id + draft_id (the
    canonical identity field — AL-1.4a,
    internal/build-AL-1.4-app-id-canonical.md §2); v29 added provided_capabilities[]
    (the app-declared half of the Layer-2 per-role tool-loading model —
    internal/spec-user-roster-and-roles-2026-06-07.md §4/§8); v28 added drift_log
    (the drift-narrative log — internal/spec-apps-meta-2026-06-13.md §9.3, Bite 3);
