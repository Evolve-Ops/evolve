...
def test_schema_version_is_30():
    ...
    docs/build-AL-1.4-app-id-canonical.md §2); v29 added provided_capabilities[]
    (the app-declared half of the Layer-2 per-role tool-loading model —
    docs/spec-user-roster-and-roles-2026-06-07.md §4/§8); v28 added drift_log
    (the drift-narrative log — docs/spec-apps-meta-2026-06-13.md §9.3, Bite 3);
