...
class TestEnableChannelInOcConfig:
    ...
    def test_adds_channels_and_plugin_entry_when_absent(self, tmp_path):
        ...
        with patch.object(_oc_common, "read_oc_config", _fake_read), \
            ...
            ok, err = discord_install.enable_channel_in_oc_config(
                "team_bot_b",
                "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.MnOpQrStUvWxYz1234567890abcdEF",
            )
        ...
        assert dc["token"] == "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.MnOpQrStUvWxYz1234567890abcdEF"
    ...
    def test_preserves_existing_policy_fields(self, tmp_path):
        ...
        with patch.object(_oc_common, "read_oc_config", _fake_read), \
            ...
            ok, err = discord_install.enable_channel_in_oc_config(
                "team_bot_b",
                "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.NewTokenValue1234567890abcdEFGH",
            )
        ...
        assert dc["enabled"] is True
        assert dc["token"] == "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.NewTokenValue1234567890abcdEFGH"
        assert staged["plugins"]["entries"]["discord"]["enabled"] is True
    ...
    def test_strips_legacy_botToken_field(self, tmp_path):
        ...
        with patch.object(_oc_common, "read_oc_config", _fake_read), \
            ...
            ok, err = discord_install.enable_channel_in_oc_config(
                "team_bot_b",
                "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.AnotherTokenValue123456abcdEFGH",
            )
        ...
        assert staged["channels"]["discord"]["token"] == "MTAxMjM0NTY3ODkwMTIzNDU2Nzg.GhIjKl.AnotherTokenValue123456abcdEFGH"
