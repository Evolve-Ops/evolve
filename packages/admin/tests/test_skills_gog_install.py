...
class TestSkillRoutes:
    def test_list_skills(self, app_with_stub_readers):
        ...
        for withdrawn in (
            ...
            # docs/skills-deep-audit-2026-05-30.md per-skill rationale.
            ...
            assert withdrawn not in ids, (
                ...
                "see docs/skills-deep-audit-2026-05-30.md"
            )
...
#
# Reference: docs/design/skills-install-roadmap-2026-05-30.md item P1.
...
def test_google_oauth_callback_kickstarts_gateway(tmp_path, monkeypatch):
    ...
    # guarding against is the callback skipping it (the bug docs/design/
