...
_EXPECTED_PRODUCERS = frozenset({
    ...
    "heal", "review", "cost", "analyze", "apply", "outcome",
    ...
    # argument shape; docs/diagnosis-spend-alert-openclaw-flag-2026-05-21.md)
    "oc_cli",
    ...
    # if the admin package is broken (docs/review-reports-subscriptions-
...
def test_cve_finding_event_is_cataloged_and_registered():
    """Bug 4 / R5 (docs/review-reports-subscriptions-2026-06-12.md):
