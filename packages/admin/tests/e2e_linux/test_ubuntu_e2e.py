...
Design: internal/design-linux-port-2026-06-10.md §9 (the `linux-e2e` job) and
...
# OBSERVE-ONLY under GitHub Actions. See internal/design-linux-port-2026-06-10.md
...
# retired (internal/design-proposal-signing-key-2026-08-18.md) and the
