...
def test_session_id_anonymous_with_request_id_is_stable():
    ...
    internal/diagnosis-evo-session-memory-loss-2026-05-20.md). The Chat-
...
# ── tier_preference rendering (internal/spec-user-tier-control-2026-05-26.md) ────
...
# ── Tier preference plumbing (internal/spec-user-tier-control-2026-05-26.md) ─────
