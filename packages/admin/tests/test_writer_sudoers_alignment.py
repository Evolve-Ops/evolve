...
See internal/diagnosis-cron-caps-applier-sudo-wall-2026-05-20.md.
"""
...
WRITER_TARGETS: list[tuple[str, str, str, str, str]] = [
    ...
    # chmod 600 because under https_pat auth the remote URL embeds a GitHub
    # PAT (token-bearing → secret_config_perms contract; 644 left the token
    # world-readable, 2026-07-28).  Missing this trio caused the 2026-05-29
...
def test_writer_target_has_cp_grant(target: tuple[str, str, str, str, str], sudoers_content: str) -> None:
    ...
    assert lines, (
        ...
        f"see internal/diagnosis-cron-caps-applier-sudo-wall-2026-05-20.md for the pattern."
    )
