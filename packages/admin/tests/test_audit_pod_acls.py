...
EVO_WRITE_DIR_ENTRY_RESOLVED = (
    # On a dir, "write" was rewritten to add_file,add_subdirectory and
    # "append" → add_subdirectory by the kernel before storage. This is
    # the exact shape ``ls -lde`` prints back.
    "user:evo allow list,add_file,add_subdirectory,delete,"
...
EVO_WRITE_DIR_ENTRY_INHERITED = (
    ...
    "user:evo inherited allow list,add_file,add_subdirectory,delete,"
    "readattr,writeattr,readextattr,writeextattr,readsecurity,"
    "file_inherit,directory_inherit"
)
