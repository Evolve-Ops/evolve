...
Spec: docs/spec-state-store-and-deploy-resilience-2026-06-10.md §2.9
...
def test_classify_soak_tier_table():
    ...
    assert c(["docs/spec-x.md", "README.md"]) == rm.SOAK_TIER_SKIP
...
def test_runtime_injected_docs_are_not_skip_tier():
    ...
    assert f("docs/spec-x.md") == rm.SOAK_TIER_SKIP
    assert c(["docs/spec-x.md", "README.md"]) == rm.SOAK_TIER_SKIP
...
def test_docs_only_candidate_skips_soak_and_promotes(pod):
    ...
    sha_b = _push_commit(pod, "docs(model-tiers): spec addendum", {
        "docs/spec-addendum-9.md": "# Addendum 9\n\nprose only\n",
    })
...
# Spec: docs/spec-delta-active-canary-validation-2026-06-13.md §D7.
#
...
# Spec: docs/spec-delta-soak-risk-tier-and-active-canary-2026-06-12.md §D4.
#
...
def test_d4_skip_tier_captures_no_baseline(pod, monkeypatch):
    ...
    sha_b = _push_commit(pod, "B: docs only", {"docs/spec-thing.md": "hi\n"})
    res = _tick(pod, deps)
...
# Spec: docs/spec-state-store-and-deploy-resilience-2026-06-10.md §2.11.
#
...
def test_d8_fixture_labels_match_overview_cell_render():
    """Plain-language relabel (docs/spec-delta-updates-vocabulary-and-direct-
...
def test_d8_release_ui_view_surfaces_promoted_at_pin_corrupt():
    """D-8 deltas (docs/spec-deploy-meta-2026-06-14.md): the Overview
