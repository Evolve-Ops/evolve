...
Strategy memo: internal/design-routes-admin-decomposition-2026-06-12.md §4.1.
...
_GOLDEN_ROUTE_TABLE: list[tuple[tuple[str, ...], str, str]] = [
    ...
    (('POST',), '/api/admin/keys/<bot_id>/<provider>/undo-rotation', 'api_admin_undo_llm_rotation'),
