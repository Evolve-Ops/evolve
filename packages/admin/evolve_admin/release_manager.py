...
Spec: internal/spec-state-store-and-deploy-resilience-2026-06-10.md Part 2.
...
# internal/spec-delta-updates-vocabulary-and-direct-default-2026-06-22.md.
...
# subprocess on every /api/status poll). See internal/spec-state-store-and-
...
def release_ui_view(
    ...
    D-8 state→representation deltas (internal/spec-deploy-meta-2026-06-14.md, and
