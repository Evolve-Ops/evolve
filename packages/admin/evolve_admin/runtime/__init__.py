...
from .isolation import Account, Identity, IsolationError, IsolationProvider, get_isolation, set_isolation  # noqa: F401  (Track I seam re-export)
...
__all__ = [
    ...
    "is_sudo_escalation_error", "is_timer_activated_oneshot",
    "Account", "Identity", "IsolationError", "IsolationProvider", "get_isolation", "set_isolation",
