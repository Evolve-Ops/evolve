...
# Pairing channels. Mirrors web.routes_bot_users.KNOWN_PROVIDERS — keep in
# sync if that list changes (no canonical single source of truth yet; the
# providers we surface in the Users UI are also the providers we count for
# the Setup checklist).
