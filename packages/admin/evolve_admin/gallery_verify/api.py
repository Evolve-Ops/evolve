...
# identity: see applications.app_identity.resolve_app_id (AL-1.4b). ``pkg_id`` here is a URL PATH SEGMENT
# (/api/gallery/<pkg_id>/install) and the parameter that builds it. No manifest
# is in scope — this module only speaks HTTP to the admin server.
