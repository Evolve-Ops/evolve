...
_REGISTRY: tuple[EvoSubcommand, ...] = (
    ...
    EvoSubcommand(
        ...
        long_help=(
            ...
            "result.\n\n"
            "Spec: internal/spec-app-coherence-and-reconciliation-2026-06-05.md §6.5 + §10.4."
        ),
        available_to=PRIMARY,
    ...
    EvoSubcommand(
        ...
        long_help=(
            ...
            "Spec: internal/spec-app-coherence-and-reconciliation-2026-06-05.md §7.6.6."
        ),
        available_to=PRIMARY,
    ...
    EvoSubcommand(
        ...
        long_help=(
            "The Continuity Engine is what lets the bot deliver on deferred "
            "commitments (\"I'll check again in 20 minutes\", \"remind me "
            "Tuesday\"). The bot schedules the follow-up itself with its "
            "built-in `defer` tool, and a pod-wide runner wakes it in the "
            "original conversation when the follow-up comes due — no "
            "approval queue."
        ),
        available_to=BOTH,
    ...
    EvoSubcommand(
        name="tier",
        # "model" alias: ChatGPT-era users guess `evo model power` on the
        # first try — meet their vocabulary. Levels stay effort-shaped
        # (the pod admin decides which models the levels map to).
        aliases=("model",),
