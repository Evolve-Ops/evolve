...
* ``action.scan.run(scope, kind)`` — dispatch a one-shot trigger to
  ...
  ``internal/audit-evo-tool-coverage-2026-06-02.md``: the "rescan", "force
...
Spec: ``internal/audit-evo-tool-coverage-2026-06-02.md`` §Pattern A.
"""
...
_SCAN_DISPATCH: dict[tuple[str, str], dict[str, str]] = {
    # ── Pattern A gaps from internal/audit-evo-tool-coverage-2026-06-02.md ──
    #
...
TOOL = Tool(
    ...
    description=(
        ...
        "internal/audit-evo-tool-coverage-2026-06-02.md: the ↻ Re-scan / "
