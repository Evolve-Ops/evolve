        ...
        "properties": {
            ...
            "urgency": {
                ...
                "description": (
                    ...
                    "values per the proposal schema are: "
                    "'security_critical', 'operational_urgent', "
                    "'cost_alert', 'substrate_warn', 'improvement', "
                    "'hygiene', 'whimsy'. Note: in-flight data may "
                    "include legacy urgencies like 'needs_attention' "
                    "or 'discretionary' — filter accepts any string."
                ),
            },
            "dimension": {
                "type": "string",
...
def _in_process_handler(
    ...
    will be auto-promoted by apply.py) don't surface here. Only
