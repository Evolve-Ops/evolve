    ...
    input_schema={
        ...
        "properties": {
            ...
            "integration_id": {
                "type": "string",
                "description": (
                    "The integration's id — the bot's mcp.servers key, "
                    "e.g. 'google_workspace'. Must already have an "
                    "autonomy row (see the Permissions page or the "
                    "/api/autonomy/inventory route)."
                ),
            },
            "rung": {
                "type": "string",
            ...
            "expected_current_rung": {
                ...
                "description": (
                    ...
                    "validate's context.current_rung. Pins the exact "
                    "transition that was confirmed — a level that "
                    "changed in between fails loudly instead of "
            ...
            "reason": {
                ...
                "description": (
                    ...
                    "history timeline on the Permissions page."
                ),
            },
        },
