...
def _cost_caps_handler(
    ...
    return {
        ...
        "effective": {
            "daily_warn_usd": be.budget_warn_cap_usd(bot_id),
            "l1_breaker_usd": be.budget_hard_cap_usd(bot_id),
        },
    }
...
COST_CAPS_TOOL = Tool(
    ...
    description=(
        ...
        "pod-default inheritance source for each, and the effective values "
        "after pod-default inheritance and monthly-budget derivation. Use "
...
COST_REMEDIATION_STATUS_TOOL = Tool(
    ...
    description=(
        ...
        "docs/spec-cost-caps-2026-06-05.md §Behavior catalog."
    ),
    input_schema={
        "type": "object",
        "properties": {
