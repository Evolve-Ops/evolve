...
(internal/spec-evo-oc-native-2026-05-19.md §3). Replaces the legacy
...
class ProxyResult:
    ...
    internal/spec-surface-aware-help-style-2026-05-22.md §7) is set when
...
def format_session_context(session_context: dict[str, Any] | None) -> str:
    ...
    # internal/spec-user-tier-control-2026-05-26.md §"session-context block
    ...
    # internal/spec-surface-aware-help-style-2026-05-22.md §2.3.4). The
...
def read_run_tool_calls(
    ...
    *,
    ...
    (internal/spec-surface-aware-help-style-2026-05-22.md) + the empty-reply
    diagnosis (internal/diagnosis-empty-reply-after-successful-tool-calls-2026-05-21.md):
...
def _synthesize_empty_reply_text(tool_calls: list[dict[str, Any]]) -> str:
    ...
    Spec: internal/spec-surface-aware-help-style-2026-05-22.md §8 Phase 1 +
    internal/diagnosis-empty-reply-after-successful-tool-calls-2026-05-21.md
