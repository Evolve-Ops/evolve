...
def _platform_tour_block(extracted: dict[str, Any]) -> str:
    ...
    return _HEADER + (
        ...
        "  - **Continuity Engine**: lets the bot pick work up when the user "
        "isn't around — capturing deferred commitments from chats (\"I'll do "
        "that tonight\", \"remind me Tuesday\"), queuing them as tasks, and "
        "running them at the right time. Inline actions can run on their "
        "own; full sessions wait for the user's OK.\n"
