...
Spec: internal/spec-evo-wizard-2026-05-05.md §4.2.
...
# Spec: internal/spec-add-bot-wizard-build-delta-2026-06-10.md §3.2 + §9.
...
# spec §4 (internal/spec-effectiveness-layer-2026-06-09.md): same enum, no
...
# for the user directly (verbatim). See internal/spec-wizard-render-modes-2026-05-15.md
