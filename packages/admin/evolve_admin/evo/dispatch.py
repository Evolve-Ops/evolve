...
def _dispatch_inner(
    ...
    *,
    ...
    # signature. Spec: internal/spec-evo-wizard-2026-05-05.md §3.2.2.
    if cmd.name == "claim":
    ...
    # profile read/write. Spec: internal/spec-user-profile-2026-05-07.md §D5.
    if cmd.name == "profile":
    ...
    # plumbing as `evo wizard` / `evo guide` — needs shared_dir +
    # user_key. Spec: internal/spec-add-bot-wizard-build-delta-2026-06-10.md §3.1.
    if cmd.name == "add-bot":
        from .wizard import engine as _wizard_engine
        shared_dir = Path(network.get("sharedDir", "/Users/Shared/evolve"))
        user_key = derive_user_key(
