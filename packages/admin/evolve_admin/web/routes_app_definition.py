...
docs/spec-apps-meta-2026-06-13.md §9.6 bite 1): the gallery files-pack
...
Spec: docs/spec-apps-meta-2026-06-13.md §9 (impl notes §9.7, §9.8).
"""
...
def register_app_definition_routes(app: Flask) -> None:
    """Register the definition promote/demote/drift-review routes on ``app``."""
