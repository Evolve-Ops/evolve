...
rung (historically standard+judge → sonnet-class; judge is now its own
judge-class per spec §Addendum 16, but a hand-authored roles map can still
collide), and the writer folds them
