...
strategy memo ``internal/design-routes-admin-decomposition-2026-06-12.md``
...
def register_skills_workspace_routes(app: Flask, network_path: Path) -> None:
    ...
    def api_skills_install_status(skill_id: str) -> Response:
        ...
        # same-day. See internal/design/skills-install-roadmap-2026-05-30.md.
    ...
    # See internal/design/skills-install-roadmap-2026-05-30.md for the per-skill
    ...
    # P3 in internal/design/skills-install-roadmap-2026-05-30.md.
    ...
    # internal/design/skills-install-roadmap-2026-05-30.md for the per-skill plan.
    #
