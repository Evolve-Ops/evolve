...
Spec: docs/spec-forge-side-effects-2026-06-02.md §5 (Forge install phase
...
docs/spec-evo-account-separation-2026-05-25.md §12) so forge's bot-side
...
def register_forge_install_routes(app: Flask) -> None:
    ...
    def api_forge_install_heartbeat_instruction() -> Response:
        ...
        Spec: docs/spec-heartbeat-instruction-2026-06-03.md §7.
    ...
    def api_forge_install_openclaw_patch() -> Response:
        ...
        return jsonify({
            ...
            "error": (
                ...
                "See docs/spec-heartbeat-instruction-2026-06-03.md."
            ),
        }), 410
