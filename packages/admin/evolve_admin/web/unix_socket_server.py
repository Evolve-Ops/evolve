...
Spec: docs/spec-evo-account-separation-2026-05-25.md §3, Phase E.3.
    ...
    *,
    ...
    while True:
        ...
        if srv is None:
            ...
            consecutive_failures = 0
            continue
        # Asking the server to shutdown raises out of serve_forever
        # in the serve thread, which the recovery wrapper catches and
        # rebinds. server_close() releases the socket FDs.
        try:
            srv.shutdown()
        except Exception:  # noqa: BLE001
