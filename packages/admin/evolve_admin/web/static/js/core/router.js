...
const pageRedirectRegistry = {
  ...
  // AL-1.8a renamed the Apps subtabs to the lifecycle (Apps / Discovered /
  // Gallery / Activity). Old deeplinks land on the tab that inherited the
  // content: "installed" → the pod-first Apps list, "forge-jobs" → Activity,
  // which now carries the forge's own table beneath the feed.
  "capabilities": { page: "apps", subtab: "apps" },
  "gallery":      { page: "apps", subtab: "gallery" },
  "forge":        { page: "apps", subtab: "activity" },
  ...
  // See internal/spec-per-bot-users-management-2026-05-29.md.
  "identity":     { page: "users" },
};
