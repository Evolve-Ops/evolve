...
const _CM_FIELDS = [
  ...
  { group: 'Context pruning',
    ...
    desc: 'How long a session can sit idle before its context is dropped from memory. Shorter = lower memory cost; the bot starts fresh more often.',
    type: 'enum',
    options: { '': '—', '15m': '15 min', '30m': '30 min', '1h': '1 hour', '4h': '4 hours' } },
  { group: 'Context pruning',
  ...
  { group: 'Optimization',
    ...
    desc: "Anthropic prompt-cache TTL applied to every Anthropic model. short = 5-min (cheapest per write); long = 1-hour (eliminates TTL invalidations on multi-minute conversational gaps).",
    type: 'enum',
