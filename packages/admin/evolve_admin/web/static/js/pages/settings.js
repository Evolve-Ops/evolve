...
function renderModules() {
  ...
  const SETTING_LABELS = {
    idleThresholdMin:      'Wait until idle for (minutes)',
    maxAgentTasksPerRun:   'Max tasks to run per cycle',
    budgetFloor:           'Minimum budget remaining ($)',
...
function renderPodAdminsList() {
  ...
  const rows = [];
  for (const [channel, ids] of Object.entries(externalIds)) {
