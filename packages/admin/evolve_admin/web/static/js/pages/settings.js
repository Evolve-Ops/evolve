...
//     saveClassifiers), renderModelsTable, and
...
function populateConfig() {
  ...
  // Security card removed 2026-08-14 — its three controls all configured
  // review.py, retired by #3641. See the note at index.html's Settings tab.
...
// saveSecuritySettings() removed 2026-08-14 with the Security card — the
// POST /api/config `security` action it drove is gone too.

// Save the Classifiers card. Two nested keys; the backend merges them into
// the classifiers.tier sub-dict so existing per-classifier overrides survive
// the save. The judge sub-dict was removed 2026-08-21 — nothing read it.
