...
function _modelTierLabel(model) {
  ...
  // Non-Anthropic ids carry no tier hint in their name (the former
  // openai/gemini → 'judge' mapping died with the judge role).
  return '';
}
...
async function _homeChatSend() {
  ...
  try {
    ...
    // Spec: internal/spec-user-tier-control-2026-05-26.md.
    ...
    // Spec: internal/spec-user-tier-control-2026-05-26.md "Power capped surface"
...
// Spec: internal/spec-severity-framework-2026-05-18.md. When present, the
...
// internal/spec-severity-framework-2026-05-18.md §1 (authority axis) + §8.
//
