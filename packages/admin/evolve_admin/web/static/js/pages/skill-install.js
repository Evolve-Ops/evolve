...
async function _skillInstallDrivePlan(plan) {
  ...
  for (let i = 0; i < steps.length; i++) {
    ...
    if (step.id === 'account_type' || step.id === 'capability_review') {
      ...
      // scope Advanced disclosure (per internal/spec-google-workspace-suite-
      // 2026-06-04.md §4.1).
      _skillInstallRenderProgress(steps, i);
      continue;
    }
...
// Spec: internal/spec-google-integration-paths-2026-05-30.md §7.
//
...
function _gwsCRenderScreen2() {
  ...
  // long-term plan (deliverable C in internal/spec-multi-user-alias-2026-06-01.md).
  ...
  if (hintEl && cur.multi_user) {
    hintEl.innerHTML = (
      ...
      '<code>internal/spec-multi-user-alias-2026-06-01.md</code>.'
    );
  }
}
