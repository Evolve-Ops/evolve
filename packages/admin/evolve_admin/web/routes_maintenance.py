...
def _report_stale_reason(report: dict) -> str | None:
    ...
    if live_installed and live_installed != recorded_installed:
...
def _register_maintenance_routes(app: Flask, network_path: Path) -> None:
    ...
    def api_oc_version() -> Response:
        ...
        docs/spec-safe-upgrade-2026-05-02.md §6.4) — but reading the
        ...
        # without a second round-trip. See docs/spec-safe-upgrade-2026-05-02.md §6.4.
        ...
        if latest_report:
            ...
            stale = bool(
                (installed_version and r_inst != installed_version)
                or (latest_version and r_resv and r_resv != latest_version)
            )
            safety_check = {
