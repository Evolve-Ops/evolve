...
AL-1.8a (docs/build-AL-1.8a-apps-shell.md §2). Thin by contract:
...
AL-1.8b (docs/build-AL-1.8b-detail-fill.md §2) extends the detail read with
...
def register_apps_routes(app: Flask, network_path: Path) -> None:
    ...
    def api_apps_discovered() -> ResponseReturnValue:
        """Pod-wide drafts. ``readiness`` / ``offer`` are null placeholders
        until AL-1.6 / AL-1.7 land their columns (brief §3)."""
        try:
