...
def create_app(network_path: Path = DEFAULT_NETWORK_CONFIG) -> Flask:
    ...
    # Bot-facing, peer-uid-bound route families: curated Google tools, the user directory, and the board's bot half (/api/board-bot/*, D-MB4).
    from .google_bot_routes import register_google_bot_routes; from .directory_bot_routes import register_directory_bot_routes; from .board_bot_routes import register_board_bot_routes  # noqa: E702
    register_google_bot_routes(app, network_path); register_directory_bot_routes(app, network_path)  # noqa: E702
    register_board_bot_routes(app, network_path)
