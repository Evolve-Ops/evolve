...
def register_oc_routes(app: Flask, network_path: Path) -> None:
    ...
    def _audit_run_one(bot_id: str, net: dict) -> dict:
        ...
        # docs/roadmap-user-value-2026-06-10.md U4.3). Best-effort: a
    ...
    def api_security_backup_status() -> Response:
        ...
        for bot_id in bots:
            ...
            try:
                ...
                if r.returncode != 0 or not ts_str:
                    ...
                    continue
                last_backup = _dt.datetime.fromisoformat(ts_str)
                hours_ago = (_dt.datetime.now(_dt.timezone.utc) - last_backup).total_seconds() / 3600
        ...
        return jsonify({"bots": result, "any_configured": any_configured})
    ...
    def api_security_backup_distribute_key() -> Response:
        ...
        See ``docs/spec-backup-key-distribution-unification-2026-06-08.md``
    ...
    _KNOWN_PROVIDERS = [
        ...
        "groq", "perplexity", "together", "deepseek", "runway", "suno",
    ]
    ...
    def _emit_integration_signals(results: dict) -> None:
        ...
        Phase 5 of docs/spec-alerts-signal-store-2026-05-07.md. One
