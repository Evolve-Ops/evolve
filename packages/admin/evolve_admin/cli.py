...
from .applications.restore_cli import register_cli as _register_restore_manifest; _register_restore_manifest(application); from .applications.app_cron_cli import register_cli as _register_repair_app_crons; _register_repair_app_crons(application); from .purge_ingested_cli import register_cli as _register_purge_ingested; _register_purge_ingested(main); from .pod_baseline_cli import register_cli as _register_pod_baseline; _register_pod_baseline(main)  # noqa: E402,E702 — bodies in helpers keep cli.py under its no-growth cap (restore-manifest + repair-app-crons + META:footprint _ingested-purge + META:pod-plane pod-baseline registrations folded onto one line)
