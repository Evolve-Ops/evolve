...
def installed_package_version(
    *, package_json: Path | None = None,
    ...
    (``ocadmin._installed_version``). Returns the canonical
    ``YYYY.M.PATCH`` form, or ``None`` if the file is missing,
    unreadable, or contains an unparseable version.
...
# Chip state — see docs/spec-app-derived-permissions-2026-05-24.md §7.
...
def evaluate_exec_policy_compliance(
    ...
    *,
    ...
    docs/spec-app-derived-permissions-2026-05-24.md §7. The function is
