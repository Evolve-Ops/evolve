...
See [internal/spec-google-path-a-2026-06-01.md](../../internal/spec-google-path-a-2026-06-01.md)
for the Path-A decisions (storage layout, refresh-token failure mode,
scope-grant enforcement) and the umbrella
[internal/spec-google-integration-paths-2026-05-30.md](../../internal/spec-google-integration-paths-2026-05-30.md)
    ...
    * ``workspace_user_oauth`` (Path B) — still raises NotImplementedError.
    ...
    if not gi:
        raise GoogleIntegrationConfigError(
            ...
            f"see internal/spec-google-integration-paths-2026-05-30.md "
            f"for the schema"
        )
    ...
    if mode == "workspace_user_oauth":
        raise NotImplementedError(
            ...
            f"in internal/spec-google-integration-paths-2026-05-30.md."
        )
