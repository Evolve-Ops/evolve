...
Spec: docs/spec-subscription-digest-default-2026-06-28.md (workstream D3).
Composes with — does NOT replace — the single-transient suppression layers:

  - docs/spec-transient-signal-suppression-2026-06-23.md (producer-side umbrella)
  - docs/spec-delta-transient-delivery-grace-2026-06-26.md (per-severity grace,
