...
Phase 5 of internal/spec-alerts-signal-store-2026-05-07.md adds a
...
(internal/spec-delta-disk-reclaim-2026-06-21.md). Unlike a CPU/mem/load
...
def emit_signals_from_snapshot(
    ...
    *,
    ...
    Phase 5 of internal/spec-alerts-signal-store-2026-05-07.md. Returns the
    ...
    internal/spec-delta-disk-reclaim-2026-06-21.md). cpu/mem/load stay crit-only.
