...
Public entry points:
  ...
  - :func:`store.write_intake`         — atomic write (update)
  ...
  - :func:`store.new_intake_id`        — fresh id (intake-YYYYMMDD-xxxxxx)
  - :func:`store.create_intake`        — write a NEW intake (never clobbers)
"""
