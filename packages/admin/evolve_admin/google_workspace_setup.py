...
Automates the manual steps in ``internal/runbook-path-c-google-integration.md``
...
See internal/runbook-path-c-google-integration.md and
internal/spec-google-integration-paths-2026-05-30.md §1 (Path C).
"""
...
def google_workspace_setup_cmd(ctx: _click.Context, project: str, bot_id: str, subject: str, workspace_domain: str, sa_name: str, secret_ref: str) -> None:  # noqa: E501
    ...
    See internal/runbook-path-c-google-integration.md.
    """
