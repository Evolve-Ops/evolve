...
def _validate_action_wiring(action: Any, idx: int) -> list[str]:
    ...
    if mechanism in _DEPRECATED_MECHANISMS:
        return [
            ...
            f"mechanism (see internal/spec-heartbeat-instruction-2026-06-03.md)."
        ]
...
def validate_scheduled_actions(pkg_or_manifest: Any) -> dict:
    ...
    - **Wiring** (manifest-v7 Slice 1, internal/spec-manifest-v7-slicing-2026-06-10.md
    ...
    msg = (
        ...
        "(see internal/spec-forge-side-effects-2026-06-02.md)."
    )
