...
class SpecDraft:
    ...
    # identity: see resolve_app_id — a SHAPE COMMENT for the LLM-authored
    # dependency entries, not a read. The one place that resolves an entry's
    # id is ``migrate_v7._migrate_app_dependencies`` (write) /
    # ``coherence_pass_a._declared_dependency_keys`` (read), both swept.
    ...
    # means "tests required". See internal/spec-app-testing-2026-05-07.md §5.
