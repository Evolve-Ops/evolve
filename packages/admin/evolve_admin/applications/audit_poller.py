...
before the 2026-06-08 rename — see docs/decision-app-tests-2026-06-08.md). No new
...
See docs/spec-app-audit-2026-05-16.md §8 for the full output integration.
"""
...
def _ingest_finding(record: dict, shared_dir: Path) -> tuple[bool, bool]:
    ...
    **PR 5: Provenance-gated emission.** Spec §8.1 — Tier 2 findings
    ...
    # See docs/spec-recommendations-rework-2026-06-02.md.
...
def _dispatch_for_tier3_finding(
    ...
    Spec: docs/spec-take-this-on-evo-dispatch-2026-06-04.md §"audit_poller
...
def _emit_audit_proposal(
    *,
    ...
    docs/spec-take-this-on-evo-dispatch-2026-06-04.md §"audit_poller mapping".
...
# docs/design-recommendation-legibility-2026-06-12.md without clipping a
...
#
# Spec: docs/spec-audit-extensions-2026-05-17.md §5.6 deliverable 5.
...
def _ingest_investigation_diagnosis(record: dict, shared_dir: Path) -> bool:
    ...
    # Spec: docs/spec-audit-extensions-2026-05-17.md §5.3 + the audit-
...
def _build_investigation_trail_url(
    ...
    ``docs/spec-pwa-phase0-https-2026-05-18.md`` §3.3.
    """
