...
Spec: docs/spec-forge-side-effects-2026-06-02.md §13.2. PR 6 of that
...
def verify_constraints(
    ...
    *,
    ...
    call_llm
        ...
        wires this to forge_engine._call_anthropic with the resolved
...
# actually collects" (docs/spec-manifest-v7-slicing-2026-06-10.md §4.1).
