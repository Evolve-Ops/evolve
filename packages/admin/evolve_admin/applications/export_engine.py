    ...
    *,
    ...
    Args:
        ...
        call_llm:                Override for the actual LLM call.
                                 ...
                                 forge_engine's ``_call_anthropic``.
    ...
    """
    if call_llm is None:
        # Defer the import so tests can patch the helper without
        # paying the forge_engine import cost.
        from .forge_engine import _call_anthropic  # noqa: WPS433
