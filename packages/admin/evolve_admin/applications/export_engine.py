...
Spec: internal/spec-scanned-export-2026-06-02.md.
...
# Smart-forge model
# (internal/note-smart-forge-and-file-provenance-2026-06-04.md): the deriver
...
def build_export_draft(
    ...
    *,
    ...
    # straight to manifest+files class (per internal/note-hybrid-gallery-
