...
# tool-loading model (docs/spec-user-roster-and-roles-2026-06-07.md §4/§8,
# docs/design-layer2-tool-loading-filter-2026-07-16.md). One new top-level list
...
# docs/design-app-spec-and-discovery-2026-08-15.md §3). Vocabulary-only bump:
...
#
# Spec: docs/spec-user-roster-and-roles-2026-06-07.md §4 (App-declared
# capabilities) + §8 (Manifest schema v7 dependency);
# docs/design-layer2-tool-loading-filter-2026-07-16.md (the Layer-2 build).
#
...
class ApplicationManifest:
    ...
    # Spec: docs/spec-user-roster-and-roles-2026-06-07.md §4/§8;
    # docs/design-layer2-tool-loading-filter-2026-07-16.md. The app-declared
    ...
    # AL-1.4a. docs/build-AL-1.4-app-id-canonical.md §2;
...
def migrate_manifest(path: Path) -> None:
    ...
    defaults: dict[str, Any] = {
        ...
        # declarations. Spec: docs/spec-user-roster-and-roles-2026-06-07.md §4/§8.
