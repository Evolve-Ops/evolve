...
# (docs/spec-apps-meta-2026-06-13.md §9). ``name`` is the app's handle; the
...
def promote_to_defined(manifest: dict, *, by: str = "ui:operator") -> dict:
    ...
    Spec: docs/spec-apps-meta-2026-06-13.md §9. REVERSIBLE (see
...
def demote_to_discovered(manifest: dict, *, by: str = "ui:operator") -> dict:
    ...
    Spec: docs/spec-apps-meta-2026-06-13.md §9 (impl notes §9.7). Idempotent.
