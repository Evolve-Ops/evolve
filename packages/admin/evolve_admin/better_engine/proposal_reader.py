...
ACTION_LABELS: dict[str, str] = {
    ...
    # AL-1.7. Without an entry the label falls back to "Review", which
    # asks the primary user to review something rather than to say yes to
    # a plainly-stated offer — the opposite of design §7.2's one breath.
    "PromoteApp": "Make it an app",
