...
# Recognised channel patterns. Advisory list — anything not on it
# produces a warning, not an error, so templates can target new
# channels without a code change.
_KNOWN_CHANNEL_PATTERNS = frozenset({
    "any-messaging",
    "slack",
    "telegram",
    "discord",
