...
pattern established in #1817. See:
  ...
  * ``internal/design/paste-token-skills-future-2026-05-30.md`` — the broader plan
  * ``internal/design/skills-install-roadmap-2026-05-30.md`` — current roadmap
...
# see internal/design/paste-token-skills-future-2026-05-30.md).
