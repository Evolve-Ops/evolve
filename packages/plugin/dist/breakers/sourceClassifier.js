 ...
 *   internal/spec-circuit-breakers-2026-05-21.md §5.2
 */
 ...
 * drill-down in internal/incident-cost-audit-2026-05-21.md.
 */
const AUTO_CHANNEL_TELLS = new Set([
    "unknown",
    "heartbeat",
    "cron",
]);
 ...
 * breaker open.
 */
export function isAutoChannelTell(channel) {
 ...
 * in internal/incident-cost-alerting-blackout-2026-05-20.md.
 *
...
export function shouldRetagHeartbeatSource(opts) {
    if (!opts.sessionTriggeredByHeartbeat)
        return false;
    const channel = (opts.channel ?? "").toLowerCase();
    if (channel !== "heartbeat")
        return false;
    const currentSource = (opts.currentSource ?? "").toLowerCase();
    if (currentSource === "heartbeat")
        return false;
    return true;
}
//# sourceMappingURL=sourceClassifier.js.map