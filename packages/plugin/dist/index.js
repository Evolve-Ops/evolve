...
import { createBoardToolFactory } from "./tools/BoardTool.js";
...
export default definePluginEntry({
    ...
    register(api) {
        ...
        // empty one.
        api.registerTool(createBoardToolFactory({ sharedDir: config.sharedDir, botId: config.botId, socketPath: adminSocketPath }, api.logger));
