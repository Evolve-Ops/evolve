 ...
 */
export function resolveSenderPlatform(ctx, event) {
    const candidates = [
        ctx?.channel,
        ctx?.messageProvider,
 ...
 */
export function platformFromSessionKey(sessionKey) {
    if (!sessionKey)
        return null;
 ...
 */
const KIND_SHAPED_CHANNEL_VALUES = new Set([
 ...
 */
export function isKindShapedChannel(raw) {
 ...
 * 2026-05-20 drill-down in docs/incident-cost-audit-2026-05-21.md).
 *
 ...
 */
export function resolveChannelKindHint(ctx) {
    ...
    if (isKindShapedChannel(rawChannelId))
        return rawChannelId;
...
//# sourceMappingURL=channelIdentity.js.map