 ...
 */
export declare const DEFAULT_ADMIN_DAEMON_SOCKET = "/Users/Shared/evolve/admin-daemon.sock";
/**
 ...
 */
export declare function adminDaemonSocketPath(sharedDir: string): string;
...
export declare class AdminSocketUnavailable extends Error {
 ...
 */
export declare function adminSocketRequest(req: AdminSocketRequest): Promise<AdminSocketResponse>;
/**
 ...
 */
export declare function extractTelegramIdFromSessionKey(sessionKey: string | undefined | null): string | null;
