 ...
 */
export function evolveAuthoredConfig(pluginLoadPath) {
    return {
        agents: {
            defaults: {
 ...
 */
export const EVOLVE_AUTHORED_KEYS = [
 ...
 */
export const EVOLVE_PLUGIN_INSTALL_FLAGS = [
    "-l",
    "--force",
    "--accept-capabilities",
];
 ...
 */
export const REQUIRED_HOOK_CTX_FIELDS = [
    "sessionKey",
    "runId",
    "trigger",
    "workspaceDir",
