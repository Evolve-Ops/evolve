...
const VALID_VERDICTS = new Set(["OK", "STRUGGLING", "AMBIGUOUS"]);
/**
 ...
 */
export function buildJudgeTailRequest() {
    return (`After your reply to the user, on its own final line, append exactly:\n` +
