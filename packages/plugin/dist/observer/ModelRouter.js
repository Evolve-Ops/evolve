...
const _LEGACY_TIER_TO_RUNG = {
    ...
    tier2: "sonnet-class",
    tier1: "opus-class",
    tier0: "judge-class", // judge owns its own rung (spec §Addendum 9)
};
/**
...
export const DEFAULT_MODEL_CATALOG = {
    rungs: [
        ...
        {
            // judge's OWN rung (spec §Addendum 9 — judge decoupled from standard).
    ...
    roles: {
        ...
        power: "opus-class",
        max: "fable-class",
        // judge rides its OWN judge-class rung (spec §Addendum 9), still
...
export function synthesizeRungsRoles(source) {
    ...
    if (tiers && typeof tiers === "object") {
        ...
        // tier0 (judge) synthesizes its OWN judge-class rung (spec §Addendum 9)
