 ...
 */
export declare class SubagentBreakerRefusal extends Error {
 ...
 */
export declare function configureSubagentBreakerGate(cfg: {
    sharedDir: string;
    botId: string;
}, logger?: MinimalLogger): void;
/** @internal test-only — drop the gate configuration and its log clock. */
export declare function _resetSubagentBreakerGateForTest(): void;
/**
 ...
 */
export declare function isInteractiveTrigger(trigger: unknown): boolean;
 ...
 */
export declare const EVOLVE_INTERNAL_PROMPT_SENTINEL = "[evolve:internal-model-call]";
/**
 ...
 */
export declare function isEvolveInternalPrompt(message: unknown): boolean;
