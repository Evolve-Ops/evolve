...
import { estimateCost, priceCall, EXACT_MODEL_COSTS, _resetPricingCatalogCache, type CostSource, type PricedCall } from "./ModelPricing.js";
...
export declare function _buildEvolveSubagentTurn(kind: EvolveSubagentTriggerKind, event: {
    ...
    provider?: unknown;
    usage?: unknown;
} | null | undefined, sharedDir?: string | null): {
    llm: SessionLlmData;
 ...
 * Pure function — no I/O, no module state — for testability.
 */
export declare function _buildScheduledToolDisciplineNote(): string;
/**
 ...
 * Pure function — no I/O, no module state — for testability.
 */
export declare function _buildRoutingNotice(driver: string | null, model: string, role: string | null, degradedFrom?: string | null): string;
/**
 ...
 * banner alone.
 */
export declare function _fallbackNoticeActiveModel(text: string): string | null;
/**
 ...
 */
export declare function _sameModelRef(active: string, override: string): boolean;
/**
 ...
 */
export declare function _isFallbackNoticePayload(payload: any): boolean;
 ...
 */
export declare function _layerCAppId(manifest: unknown): string;
...
export declare class TurnObserver {
     ...
     */
    private _loggedMissingHeartbeatWorkspaceDir;
    private static readonly _DUE_WAKE_MAX_RUNS;
    private summarizer;
    private modelRouter;
    /**
     ...
     */
    private readonly _pendingJudgeTail;
    /**
     ...
     * a hook later.
     */
    private readonly _armedJudgeTail;
    /**
     ...
     */
    private readonly _preflightCap;
    /**
     ...
     */
    private _housekeepingRuns;
    private _housekeepingLever;
     ...
     */
    private _breakerSpokenConversations;
     ...
     */
    handleReplyPayloadSending(event: any): {
        payload?: any;
    } | undefined;
     ...
     */
    handleBeforeAgentReply(runId: string | undefined | null, ctx?: {
        trigger?: unknown;
    ...
    private _housekeepingKindForRun;
    /**
     ...
     */
    private _handleCostCheckpointTurn;
    /**
     ...
     */
    private _recordCheckpointAnswer;
