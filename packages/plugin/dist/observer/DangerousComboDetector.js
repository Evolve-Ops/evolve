 ...
 *
 * Spec: internal/spec-tier-cascade-2026-05-26.md § 2.6.
 *
...
export const DEFAULT_DANGEROUS_COMBO_CONFIG = {
    enabled: true,
 ...
 */
export function detectDangerousCombo(input, config) {
    const cfg = {
    ...
    const allFour = featuresMatched.background_origin
...
//# sourceMappingURL=DangerousComboDetector.js.map