...
import { ModelRouter, synthesizeRungsRoles, normalizeRouting, mergeModelCatalog, parseTierDirective, defaultRoleCap, sanitizeDailyCap, splitProviderModelRef, } from "./ModelRouter.js";
...
export function _buildEvolveSubagentTurn(kind, event) {
    ...
    return {
        ...
        costEstimated: estimateCost(model, inputTokens, outputTokens, cacheWriteTokens, cacheReadTokens),
    };
}
/**
                ...
                try {
                    ...
                    try {
                        const downgrade = runId
                            ...
                            : undefined;
                        if (downgrade) {
                            costDowngradeBlock = _buildCostDowngradeNotice(downgrade.driver, downgrade.model);
                        }
                    }
        ...
        if (modelOverride) {
            ...
            if (costDriver && ctx?.runId) {
                if (this._costDowngradeRuns.size >= 1024) {
                    ...
                    if (oldest !== undefined)
                        this._costDowngradeRuns.delete(oldest);
                }
