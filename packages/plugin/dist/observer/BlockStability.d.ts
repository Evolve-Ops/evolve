...
export declare const EVOLVE_PREFIX_BLOCK_ORDER: readonly ["capabilities", "toolDiscipline", "digest", "narrative", "speaker", "costDowngrade"];
 ...
 */
export declare const EVOLVE_PREFIX_TAIL_BLOCKS: readonly EvolvePrefixBlockName[];
/**
 ...
 */
export declare function composeEvolvePrefix(blocks: EvolvePrefixBlocks): ComposedEvolvePrefix;
