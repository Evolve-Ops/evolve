 ...
 * (internal/spec-evolve-overhead-budget-2026-07-31.md): eight schemas rode in
 ...
 *
 * Spec: internal/spec-primary-bot-interface-2026-05-14.md §5. The bot calls
...
export declare const PodStateParamsSchema: import("@sinclair/typebox").TObject<{
    query: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"status" | "watchdog" | "signals" | "bot" | "turns" | "proposals" | "spend" | "audits">[]>;
