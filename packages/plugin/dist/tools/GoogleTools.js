 ...
 * sent in the body.
 */
function adminSocketPost(socketPath, urlPath, payload) {
 ...
 */
export function googleConfiguredForBot(sharedDir, botId) {
    try {
...
const StrReq = (description) => Type.String({ description });
const IntOpt = (description) => Type.Optional(Type.Integer({ description }));
const TOOL_DEFS = [
    // ── Gmail read ──
    {
        name: "gmail_list_messages",
        description: "List messages in your Gmail mailbox. Optional `q` (Gmail search, e.g. " +
    ...
    },
    {
        ...
        description: "List Gmail labels (system + user) with their ids — use this to learn " +
    ...
    {
        name: "gmail_send",
        description: "Send an email from your mailbox. Requires `to`, `subject`, `body`. " +
        ...
        params: Type.Object({
            ...
            attachments: Type.Optional(Type.Array(Type.String(), {
                description: "File paths inside your workspace, absolute or workspace-relative " +
    ...
    },
    {
        ...
        description: "Add and/or remove labels on a message. At least one of `add_label_ids` " +
    ...
    },
    {
        ...
        description: "PERMANENTLY delete a message (not Trash — unrecoverable). Requires " +
    ...
    },
    {
        ...
        description: "Move a message to Trash — recoverable (~30 days, then purged). This " +
    ...
    // ── Calendar ──
    {
        ...
        description: "List upcoming calendar events. Optional `calendar_id` (default " +
    ...
    },
    {
        ...
        description: "Create a calendar event. Requires `summary`, `start`, `end` (ISO 8601 " +
    ...
    // ── Drive ──
    {
        ...
        description: "List Drive files you own or are shared on (drive.file scope). Optional " +
    ...
    },
    {
        ...
        description: "Fetch a Drive file's content (text decoded; binary as base64). Google-" +
    ...
    },
    {
        ...
        description: "Create a file in your Drive. Requires `name`, `content`. Optional " +
    ...
    {
        name: "drive_search",
        description: "Search across ALL Drive files visible to you (drive.readonly scope) — " +
 ...
 */
export function createGoogleToolFactories(config, logger) {
    const socketPath = join(config.sharedDir, SOCKET_NAME);
    return TOOL_DEFS.map((def) => (_ctx) => ({
        name: def.name,
        ...
        async execute(_toolCallId, rawParams) {
            ...
            try {
                ...
                const err = (res.body && (res.body.detail || res.body.error)) ||
                    `HTTP ${res.status}`;
...
//# sourceMappingURL=GoogleTools.js.map