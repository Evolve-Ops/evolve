...
export declare const SetTierToolParamsSchema: import("@sinclair/typebox").TObject<{
    ...
    scope: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TLiteral<"session">, import("@sinclair/typebox").TLiteral<"standing">]>>;
