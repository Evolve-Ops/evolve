...
export function formatRow(row: MatrixRow): string {
...
export function parseRow(line: string): MatrixRow | null {
...
export function rowForRun(run: ContractRun): MatrixRow {
  return {
 ...
 */
export function upsertRow(markdown: string, row: MatrixRow): string {
