...
import {
  createUsersWhoamiToolFactory,
  createUsersListToolFactory,
} from "./tools/UsersTools.js";
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    installToolProfileFilter(
      api, { botId: config.botId, sharedDir: config.sharedDir }, api.logger,
    );
