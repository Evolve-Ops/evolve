...
// ── OpenClaw middleware contract (mirrors OC source) ─────────────────────────
...
export type OpenClawAgentToolResultContentBlock =
  | OpenClawAgentToolResultTextBlock
  | OpenClawAgentToolResultImageBlock;
 ...
 */
export const EVOLVE_APP_INTEGRITY_VERSION = 1 as const;
