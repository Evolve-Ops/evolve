 ...
 * docs/spec-user-tier-control-2026-05-26.md "Architecture →
 * ModelRouter changes":
 *
...
test("userTier=power on a config without tier1 → returns null (fail open)", () => {
  const cfg = {
    tiers: { tier2: { models: ["sonnet"] }, tier3: { models: ["haiku"] } },
    routing: { enabled: true },
  };
