...
test("getRoleForModel: reverse lookup over a four-rung catalog (judge included)", () => {
  // Historically this fixture arrived as a legacy {tiers} config and was
  // synthesized in the constructor; it is now authored directly in the
  // rungs/roles shape (the legacy shape refuses since 2026-08-15).
  const router = new ModelRouter(
    {
      rungs: [
        { id: "haiku-class", models: ["anthropic/claude-haiku-4-5"], costClass: "low" },
        ...
        { id: "judge-class", models: ["openai/gpt-4o"], costClass: "medium" },
      ],
      roles: {
        fast: "haiku-class",
        standard: "sonnet-class",
