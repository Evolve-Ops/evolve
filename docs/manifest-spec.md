...
> `spec-manifest-v7-2026-05-20.md` and
> `spec-manifest-v7-slicing-2026-06-10.md` §5.1.
...
| `test_cadence` | string \| null | Per-app override of `app_testing.default_cadence` in `network.json`. One of `off`, `on_change`, `light`, `strict`. `null` means inherit pod default. See `spec-app-testing-2026-05-07.md` §3. |
...
| `last_result` | string \| null | `pass` \| `fail` \| `partial` \| `error`. `error` is reserved for trigger/judge failure (separated from `fail` for telemetry). See `spec-behavioral-runs-2026-05-07.md` §2. |
