...
2. **User profile** — a binary signal indicating whether the bot has recorded anything about its primary user. Profile *contents* are deliberately not surfaced here. Spec: `docs/spec-user-profile-2026-05-07.md`.
