...
#### Continuity Engine (`task_runner.py`)
Runs every 15 minutes. Executes inline tasks immediately; dispatches agent tasks when the human is idle. See the Continuity help for detailed configuration.
