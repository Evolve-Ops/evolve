...
- `pod_perms_drift_monitor` — hourly, watches for between-deploy ACL / ownership drift on shared directories. Emits a Signal when a managed dir's permissions change outside a deploy. Added [PR 2217](https://github.com/evolve-ops/evolve/pull/2217).
