...
- [`docs/spec-tier-cascade-2026-05-26.md`](spec-tier-cascade-2026-05-26.md) — the original cascade design (now superseded as primary by pre-flight)
- [`docs/spec-preflight-intent-router-2026-06-06.md`](spec-preflight-intent-router-2026-06-06.md) — the pre-flight router that emerged from this reframe (to be written)
