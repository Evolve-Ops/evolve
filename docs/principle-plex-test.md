...
- `spec-primary-bot-interface-2026-05-14.md` — primary-bot copy constraints
- `spec-surface-aware-help-style-2026-05-22.md` — formalizes the primary/secondary surface distinction for help text
