...
**Adopted:** 2026-05-31, promoting the rule already cited by name in [spec-app-audit-2026-05-16.md](spec-app-audit-2026-05-16.md) as "the per-bot inference principle" and described as "Privacy by architecture" in [product-vision.md](product-vision.md).
...
- **Not a substitute for opt-out controls.** Per [feedback_user_observation_optout](memory/feedback_user_observation_optout.md), observation features still ship with user-flippable DNT switches and wipe paths. Per-bot inference is the *architectural* privacy story; per-user opt-out is the *user-facing* one. Both are required.
...
- [spec-app-audit-2026-05-16.md](spec-app-audit-2026-05-16.md) §"Ownership: bot, not Evolve" (line 7) — the canonical "per-bot inference principle" citation
...
- [feedback_user_observation_optout](memory/feedback_user_observation_optout.md) — the user-facing opt-out complement
- [feedback_per_bot_inference](memory/feedback_per_bot_inference.md) — the established memory for this principle, now superseded by this doc
