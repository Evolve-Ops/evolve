...
**Adopted:** 2026-05-31, consolidating the producer/generator split that has become the pod-wide pattern (see `spec-alerts-signal-store-2026-05-07.md` and `spec-app-permission-drift-2026-05-25.md`).
...
Every monitor → generator pair on the pod follows this shape (cited at `spec-app-permission-drift-2026-05-25.md:34-36`). The reference pairs:
...
- `spec-alerts-signal-store-2026-05-07.md` — the Signal store design (canonical)
- `spec-app-permission-drift-2026-05-25.md` — explicit "mirrors the existing producer/generator split" framing
- CLAUDE.md §"Signal store" and §"Event-driven generator dispatch" — operational layout
- `project_alerts_signal_store` — pod-wide consolidation status (Phase 4 first then 0/1/2/3/5/6)
- `project_better_engine_pipeline_unification` — the 6-PR sprint that migrated scoreboard/compliance/suggestions to Signals→Proposals
