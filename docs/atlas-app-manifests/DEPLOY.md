...
- [ ] **Mini SSH access** as `pod-admin-user@mini` (see [reference_ssh_mini_host](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/reference_ssh_mini_host.md))
...
`deploy` runs the full 8-step deploy: plugin build, OC plugin install, workspace setup, gateway plist, smoke audit. **If the smoke audit surfaces critical findings, do NOT pass `--allow-audit-criticals` — fix the findings first** (per [feedback_evolve_dev_not_test_pod](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/feedback_evolve_dev_not_test_pod.md)).
...
[docs/spec-workspace-file-sync-2026-06-07.md](../spec-workspace-file-sync-2026-06-07.md).
...
Per [Pod-Admin's workflow](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/feedback_pod-admin_workflow_design_ship_retrospect.md): ship, use, retrospect.
...
- Whether the schema v7 work (per [manifest-schema-v7-recommendation](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/project_manifest_schema_v7_recommendation.md)) feels urgent now
...
- [reference_evolve_admin_cli](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/reference_evolve_admin_cli.md) — CLI syntax
- [reference_ssh_mini_host](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/reference_ssh_mini_host.md) — SSH conventions
- [reference_sudo_evolve_python_cwd](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/reference_sudo_evolve_python_cwd.md) — why `cd /tmp` before `sudo -u`
- [feedback_evolve_dev_not_test_pod](../../.claude/projects/-Users-pod-admin-GitHub-evolve/memory/feedback_evolve_dev_not_test_pod.md) — fix bugs structurally, don't bypass
