...
preflight ([docs/spec-safe-upgrade-2026-05-02.md](spec-safe-upgrade-2026-05-02.md))
...
proposals graded by a verify daemon. Continuity Engine for cross-session task
carryover. App Gallery for one-click installs; Forge for spec-driven
...
Spec: [docs/spec-per-bot-users-management-2026-05-29.md](spec-per-bot-users-management-2026-05-29.md).
...
Bot sessions are stateless by default. The Continuity Engine extracts
pending commitments from session transcripts, surfaces them at the next
session start, and runs pre-approved recurring tasks (weekly review, cost
summary, project digest) on a schedule. It's the thing that keeps a bot's
promises across conversations without you having to remind it.
...
- **[Judge Tier Should Differ from Workhorse Tier (Anti-Goodhart)](principle-judge-tier-differs-from-workhorse.md)** — recommendation, not a gate: when `tier0` and `tier2` resolve to the same provider, LLM-as-judge calls over-rate their own family's output; the AI Optimization page nudges operators toward a cross-provider pair but no behavior is blocked when they aren't.
...
[separation onto a dedicated `evo` account specced](spec-evo-account-separation-2026-05-25.md)
...
[docs/spec-alerts-signal-store-2026-05-07.md](spec-alerts-signal-store-2026-05-07.md).
...
4. **MCP servers, plugins, hooks** — per-bot inventory + baseline drift
   ...
   [spec-mcp-administration-2026-05-10.md](spec-mcp-administration-2026-05-10.md),
   [spec-plugin-inventory-2026-05-10.md](spec-plugin-inventory-2026-05-10.md),
   [spec-hook-governance-2026-05-10.md](spec-hook-governance-2026-05-10.md)).
5. **Permission posture** — exec-allowlist coverage, app-derived
   permissions reconciliation
   ([spec-app-derived-permissions-2026-05-24.md](spec-app-derived-permissions-2026-05-24.md)).
