...
| **Continuity engine** | Bots schedule their own follow-ups the moment they commit ("remind me in 20 minutes"), and a background runner fires them on time. Makes stateless bots feel continuous. |
...
# Set up Python environment (Python 3.10+; analyzer first — admin depends on it)
...
Full pre-install checklist: [docs/pre-install-checklist.md](../pre-install-checklist.md)
