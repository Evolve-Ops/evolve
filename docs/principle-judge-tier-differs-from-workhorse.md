...
`packages/admin/evolve_admin/applications/behavioral_runner.py` (`_resolve_judge_model`) resolves the judge in this order:
...
- `packages/admin/evolve_admin/applications/behavioral_runner.py` — the one live LLM-as-judge surface; tier-walk fallback.
