...
Why this exists
---------------
The 2026-05-30 skills deep audit (docs/skills-deep-audit-2026-05-30.md) read only
...
The 2026-06-04 follow-up audit (docs/openclaw-coverage-audit-2026-06-04.md, F1
...
audit framework (docs/skills-deep-audit-2026-05-30.md §Method update) references
...
def diff_against_snapshot(current: list[Channel], snapshot_path: Path) -> tuple[bool, str]:
    ...
    parts.append(
        ...
        "OR document the skip in docs/openclaw-coverage-audit-2026-06-04.md Bucket C."
    )
    return False, "\n".join(parts)
