...
- Public product docs: docs/  (ships to the public repo — allowlisted in docs/public-manifest.yaml)
- Internal docs (specs, designs, decisions, audits, build briefs, incidents, META): internal/  (never ships)
